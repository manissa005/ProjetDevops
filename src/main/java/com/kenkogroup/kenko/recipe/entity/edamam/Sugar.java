...
public class Sugar implements Serializable
{
    ...
    private final static long serialVersionUID = -5730209958992543910L;
    ...
    public String toString() {
        ...
        sb.append(Sugar.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
