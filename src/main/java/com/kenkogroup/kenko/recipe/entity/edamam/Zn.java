...
public class Zn implements Serializable
{
    ...
    private final static long serialVersionUID = 4145753909980149395L;
    ...
    public String toString() {
        ...
        sb.append(Zn.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("label");
        sb.append('=');
